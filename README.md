...
## Вывод
1) Разработан скрипт на PowerShell для поиска строки в текстовых файлах
2) Изучены основные командлеты: Get-ChildItem, Select-String, ForEach-Object
3) Реализована обработка параметров командной строки ($args)
4) Скрипт выполняет ту же задачу, что и bash-версия, но средствами Windows
