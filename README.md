...
## Вариант: тот же, что и в lab_3a. В текстовых файлах (.txt) найти заданную в параметре сценария строку, из найденных файлов составить список, сохранить его в файл

## Тема: Поиск строки в текстовых файлах и сохранение списка найденных файлов (аналог bash-скрипта).

Скрипт FindString.ps1
<img width="957" height="552" alt="image" src="https://github.com/user-attachments/assets/cc37c307-46d8-4292-8d1e-4481b88f0f8d" />

Работа с командной строкой PowerShell. Вывод результата. Создание текстовых файлов с ключевым словом "hello"
<img width="959" height="844" alt="image" src="https://github.com/user-attachments/assets/d2cb14ea-9524-4eb0-9a50-befd76ae295f" />

## Вывод
1) Разработан скрипт на PowerShell для поиска строки в текстовых файлах (.txt)
2) Изучены основные команды: Get-ChildItem, Select-String, ForEach-Object
3) Реализована обработка параметров командной строки ($args)
4) Скрипт выполняет ту же задачу, что и в bash, но с помощью Windows PowerShell
